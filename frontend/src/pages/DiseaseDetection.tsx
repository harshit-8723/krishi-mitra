...
export default function DiseaseDetection() {
  ...
  const handlePredict = async () => {
    ...
    try {
      ...
      // Voice output
      speakResult(
        `Predicted Disease: ${data.predicted_disease}. Confidence: ${data.confidence}. Description: ${data.description}`
      );
    ...
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Plant Disease Detection</h1>
            ...
            {!selectedImage ? (
              ...
              <div className="space-y-4">
                <div className="relative rounded-2xl overflow-hidden border border-border">
                  <img src={selectedImage} alt="Selected plant" className="w-full h-auto max-h-96 object-contain bg-muted" />
                  <Button variant="destructive" size="icon" onClick={handleRemoveImage} className="absolute top-4 right-4">
                    <X className="h-4 w-4" />
                  </Button>
                </div>
                ...
                <Button onClick={handlePredict} disabled={loading} className="w-full gradient-primary h-12 text-lg">
                  {loading ? (
                    <>
            ...
            <div className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-gradient-to-br from-emerald-500/10 to-teal-600/10 rounded-xl border border-emerald-500/20">
                  ...
                  <h3 className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">{result.predicted_disease}</h3>
                </div>
                ...
                <div className="p-6 bg-gradient-to-br from-blue-500/10 to-cyan-600/10 rounded-xl border border-blue-500/20">
                  ...
                  <h3 className="text-2xl font-bold text-blue-600 dark:text-blue-400">{result.confidence}</h3>
                </div>
              </div>
